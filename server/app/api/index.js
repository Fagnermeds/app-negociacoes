...
api.listaSemana = function(req, res) {
    var negociacoesAtuais = negociacoes.filter(function(Negotiation) {
        return Negotiation.data > dataAnterior;
    });
...
api.listaAnterior = function(req, res) {
   ...
   var negociacoesAnteriores = negociacoes.filter(function(Negotiation) {
        return Negotiation.data < dataAtual && Negotiation.data > dateRetrasada;
    });
	setTimeout(function() {
...
api.listaRetrasada = function(req, res) {
   ...
   var negociacoesRtrasadas = negociacoes.filter(function(Negotiation) {
        return Negotiation.data < dataAnterior;
    });
...
api.cadastraNegotiation = function(req, res) {
